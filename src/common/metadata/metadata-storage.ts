import { AUTO_GENERATE_ATTRIBUTE_STRATEGY, EntityTarget } from 'src/common';
import { AttributeOptionsUniqueType } from 'src/common/decorators/attribute.decorator';
import { ScalarType } from 'src/common/helpers/scalar-type';
import {
  EntityAliasOrString,
  IndexOptionsWithAlias,
} from 'src/common/index-options';
