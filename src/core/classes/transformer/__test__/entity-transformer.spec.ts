...
import { CATEGORY, Photo } from 'src/core/__mocks__/photo';
import { table } from 'src/core/__mocks__/table';
import { User } from 'src/core/__mocks__/user';
import { UserAutoGenerateAttributes } from 'src/core/__mocks__/user-auto-generate-attributes';
import { UserSparseIndexes } from 'src/core/__mocks__/user-sparse-indexes';
import { UserAttrAlias } from 'src/core/__mocks__/user-with-attribute-alias';
...
import { UserCustomConstructor } from 'src/core/__mocks__/user-custom-constructor';
import { UserWithDefaultValues } from 'src/core/__mocks__/user-default-value';
