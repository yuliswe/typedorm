...
import {
  BaseExpressionInput,
  MERGE_STRATEGY,
} from 'packages/core/classes/expression/base-expression-input';
...
} from 'packages/core/classes/expression/update-body-type';
import { AddUpdate } from 'packages/core/classes/expression/update/add-update';
import { SetUpdate } from 'packages/core/classes/expression/update/set-update';
import { Update } from 'packages/core/classes/expression/update/update';
import { isScalarType } from 'packages/core/helpers/is-scalar-type';

import { DeleteUpdate } from 'packages/core/classes/expression/update/delete-update';
import { RemoveUpdate } from 'packages/core/classes/expression/update/remove-update';
import { nestedKeyAccessRegex } from 'packages/core/helpers/constants';
