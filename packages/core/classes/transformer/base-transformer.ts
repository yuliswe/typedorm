...
import { IsAutoGeneratedAttributeMetadata } from 'packages/core/classes/metadata/auto-generated-attribute-metadata';
import {
...
import { isDynamoEntityKeySchema } from 'packages/core/helpers/is-dynamo-entity-key-schema';
...
export abstract class BaseTransformer {
   ...
   * @private
   * @param schema schema to resolve, eg. { PK: 'USER#{{id}}', SK: 'USER#{{id}}' }
  ...
  protected recursiveParseEntity<Entity = any>(
    ...
    const parsedSchema = Object.keys(schema).reduce((acc, key) => {
      ...
      if (
        // currentValue is a string such as 'USER#{{id}}'
