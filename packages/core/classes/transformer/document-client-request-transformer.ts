...
import { AttributeMetadata } from 'packages/core/classes/metadata/attribute-metadata';
import type { DynamoEntitySchemaPrimaryKey } from 'packages/core/classes/metadata/entity-metadata';
import {
  BaseTransformer,
  MetadataOptions,
} from 'packages/core/classes/transformer/base-transformer';
...
import { dropProp } from 'packages/core/helpers/drop-prop';
import { getConstructorForInstance } from 'packages/core/helpers/get-constructor-for-instance';
import { parseKey } from 'packages/core/helpers/parse-key';
